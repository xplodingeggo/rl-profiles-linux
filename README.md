...
A: Probably not. i did try it with one border (xp level 275) and it just looked weird since the profile picture goes over the border. It might work fine on some though as long as they dont obstruct the main part of the box (alot of the xp level ones do)
