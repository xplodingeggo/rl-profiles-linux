...
_WINDOWS_SCOREBOARD_LAYOUTS = {
    ...
    # target is 822-25=797, then -2px to 795, then -1px to 794, then
    # -1px more to 793 (final) — base reset to 793; EXTRA_Y_QUAD
    # ["orange"][2] keeps the previously-confirmed s=1.0 target (817)
    # exact.
    2: {"blue": 591, "orange": 793},  # blue was 553(s=1.0-only fudge)/535/593/592; orange was 756/812/821/822(s=1.0-only fudge)/797/795/794
